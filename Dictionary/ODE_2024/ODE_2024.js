...
$(function () {
    $(".ode-2024").each(function () {
        ...
        function setupSenseFold() {
            $ode.find('.entryPageContent').each(function () {
                ...
                const $sense = $entryContainer.find('.msDict.sense, .msDict.subsense, li.sense').filter(function () {
                    return $(this).closest('section.phrases, section.phrasalVerbs').length === 0;
                });
                let $iterations = $();
        ...
        function detectDarkModeEnabled() {
            ...
            const handleThemeChange = event => $ode.attr('data-theme', event.matches ? 'dark' : 'light');
            ...
            function setTheme() {
                if (document.body.classList.contains('black') || document.body.classList.contains('night')) {
                    $ode.attr('data-theme', 'dark');
                } else {
                    $ode.attr('data-theme', 'light');
                }
            }
